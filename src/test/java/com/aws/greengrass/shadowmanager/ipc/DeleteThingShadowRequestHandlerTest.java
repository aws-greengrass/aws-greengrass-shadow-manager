...
class DeleteThingShadowRequestHandlerTest {
    ...
    void GIVEN_valid_request_WHEN_handle_request_THEN_return_valid_response(String shadowName) throws URISyntaxException, IOException {
        ...
        DeleteThingShadowRequestHandler deleteThingShadowIPCHandler = new DeleteThingShadowRequestHandler(mockDao, mockAuthorizationHandlerWrapper, mockPubSubClientWrapper, mockSynchronizeHelper, mockSyncHandler);
        when(mockDao.deleteShadowThing(any(), any())).thenReturn(Optional.of(new ShadowDocument(allByteData)));

        DeleteThingShadowResponse actualResponse = deleteThingShadowIPCHandler.handleRequest(request, TEST_SERVICE);
    ...
    void GIVEN_delete_thing_shadow_ipc_handler_WHEN_document_not_found_THEN_throw_resource_not_found_exception(ExtensionContext context) throws IOException {
        ...
        DeleteThingShadowRequestHandler deleteThingShadowIPCHandler = new DeleteThingShadowRequestHandler(mockDao, mockAuthorizationHandlerWrapper, mockPubSubClientWrapper, mockSynchronizeHelper, mockSyncHandler);
            ResourceNotFoundError thrown = assertThrows(ResourceNotFoundError.class, () -> deleteThingShadowIPCHandler.handleRequest(request, TEST_SERVICE));
    ...
    void GIVEN_delete_thing_shadow_ipc_handler_WHEN_dao_sends_data_exception_THEN_throw_service_exception(ExtensionContext context) throws IOException {
        ...
        DeleteThingShadowRequestHandler deleteThingShadowIPCHandler = new DeleteThingShadowRequestHandler(mockDao, mockAuthorizationHandlerWrapper, mockPubSubClientWrapper, mockSynchronizeHelper, mockSyncHandler);
            ServiceError thrown = assertThrows(ServiceError.class, () -> deleteThingShadowIPCHandler.handleRequest(request, TEST_SERVICE));
    ...
    void GIVEN_unauthorized_service_WHEN_handle_request_THEN_throw_unauthorized_error(ExtensionContext context) throws Exception {
        ...
        DeleteThingShadowRequestHandler deleteThingShadowIPCHandler = new DeleteThingShadowRequestHandler(mockDao, mockAuthorizationHandlerWrapper, mockPubSubClientWrapper, mockSynchronizeHelper, mockSyncHandler);
            UnauthorizedError thrown = assertThrows(UnauthorizedError.class, () -> deleteThingShadowIPCHandler.handleRequest(request, TEST_SERVICE));
    ...
    void GIVEN_invalid_request_input_WHEN_handle_request_THEN_throw_invalid_arguments_error(String thingName, String shadowName, ExtensionContext context) throws IOException {
        ...
        DeleteThingShadowRequestHandler deleteThingShadowIPCHandler = new DeleteThingShadowRequestHandler(mockDao, mockAuthorizationHandlerWrapper, mockPubSubClientWrapper, mockSynchronizeHelper, mockSyncHandler);
            InvalidArgumentsError thrown = assertThrows(InvalidArgumentsError.class, () -> deleteThingShadowIPCHandler.handleRequest(request, TEST_SERVICE));
